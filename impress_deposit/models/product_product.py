...
class ProductTemplate(models.Model):
    ...
    requires_deposit = fields.Boolean('Requires Deposit', compute='_compute_requires_deposit', inverse='_set_requires_deposit')
    qty_multiple = fields.Integer('Quantity for deposit', compute='_compute_qty_multiple', inverse='_set_qty_multiple')
