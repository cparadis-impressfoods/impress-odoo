...
class SaleOrder(models.Model):
    ...
    linked_production_ids = fields.One2many('mrp.production', 'billing_sale_order_id', string='Linked Productions', copy=False)
    linked_production_count = fields.Integer("Count of linked MOs", compute='_compute_linked_production_ids')
