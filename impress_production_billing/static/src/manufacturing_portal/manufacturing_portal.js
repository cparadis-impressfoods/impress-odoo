...
export class ManufacturingPortalWebClient extends Component {
    setup() {
    ...
    async _showView() {
        const { action_name, manufacturing_id } = session;
        await this.actionService.doAction(
            action_name,
            {
                props: {
                    resId: manufacturing_id,
                    preventEdit: true,
                    preventCreate: true,
                },
                additionalContext: {
...
ManufacturingPortalWebClient.components = { ActionContainer, MainComponentsContainer };
ManufacturingPortalWebClient.template = 'impress_production_billing.ManufacturingPortalWebClient';
